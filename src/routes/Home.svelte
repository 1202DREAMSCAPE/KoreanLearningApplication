...
<section class="text-center space-y-6">
  <div class="space-y-3">
    ...
    <h1 class="h1">Make Korean stick</h1>
    <p class="subtle">Spaced repetition, sentence building, and a friendly in-app Hangul keyboard.</p>
  </div>
...
<section class="grid md:grid-cols-3 gap-4">
  ...
  <div class="card p-5">
    <div class="h2">Built-in Hangul</div>
    <p class="subtle mt-1">No OS toggle—compose Korean directly with an on-screen keyboard.</p>
  </div>
</section>
